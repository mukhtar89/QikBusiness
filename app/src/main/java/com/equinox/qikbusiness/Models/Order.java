...
import static com.equinox.qikbusiness.Models.Constants.CONSUMER;
import static com.equinox.qikbusiness.Models.Constants.DEADLINE;
import static com.equinox.qikbusiness.Models.Constants.DRIVER;
import static com.equinox.qikbusiness.Models.Constants.EXCHANGE_ITEM;
import static com.equinox.qikbusiness.Models.Constants.ORDER_ITEMS;
import static com.equinox.qikbusiness.Models.Constants.ORDER_PAYLOAD;
import static com.equinox.qikbusiness.Models.Constants.ORDER_STATUS;
import static com.equinox.qikbusiness.Models.Constants.TIMESTAMP;
...
public class Order {
    ...
    public Order fromMap(Map<String,Object> entry) {
        ...
        from = new User().fromMap((HashMap<String, Object>) entry.get(CONSUMER));
