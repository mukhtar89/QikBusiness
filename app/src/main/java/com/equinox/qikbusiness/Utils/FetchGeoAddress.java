...
import static com.equinox.qikbusiness.Models.Constants.GEOCODE_API_KEY;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                JsonObjectRequest ratingsReq =
                        new JsonObjectRequest(baseURL + DataHolder.currentUser.getAddress().getAddressElements().get(0).getName(), null, new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                Log.d(TAG, response.toString());
                                try {
